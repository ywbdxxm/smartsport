...
- [ ] **Step 1: Write the failing host test and build description**
...
- [ ] **Step 2: Run the host build and prove RED**
...
- Produces: `const char *storage_sd_get_mount_point(storage_sd_handle_t handle)`.
...
- [ ] **Step 1: Define the narrow public API and ownership contract**
...
- [ ] **Step 2: Implement mount with complete failure cleanup**
...
- [ ] **Step 3: Implement exact 32 KiB smoke behavior**
...
- [ ] **Step 4: Implement lifecycle cleanup and documentation**
...
- [ ] **Step 3: Update build dependencies and operator documentation**
...
- [ ] **Step 2: Run a clean target configure and build**
...
- [ ] **Step 3: Run static repository checks and self-review**
...
- [ ] **Step 5: Record the hardware skip**
